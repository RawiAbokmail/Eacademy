<?php $__env->startSection('title', 'Teacher Single'); ?>
<?php $__env->startSection( 'content'); ?>
    ...
    <section id="page-banner" class="pt-105 pb-130 bg_cover" data-overlay="8" style="background-image: url(<?php echo e(asset('backend/images/page-banner-3.jpg')); ?>)">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
                                <div class="dashboard-cont">
                                    ...
                                    <div class="singel-dashboard pt-40">
                                        <h5>Acchivments</h5>
                                        <p><?php echo e($teacher->achievements); ?></p>
                                    </div> <!-- singel dashboard -->
                                    <div class="singel-dashboard pt-40">
                                        <h5>My Objective</h5>
                                        <p><?php echo e($teacher->objective); ?></p>
                                    </div> <!-- singel dashboard -->
                                </div> <!-- dashboard cont -->
                            </div>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\Eacademy\resources\views/eacademy/teachers-single.blade.php ENDPATH**/ ?>