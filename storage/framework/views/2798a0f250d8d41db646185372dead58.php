...
unset($__errorArgs, $__bag); ?>
    ...
    <?php if($type == 'file' && $value && $name == 'image'): ?>
        <div>
            <img class="img-thumbnail mt-1" width="100" src="<?php echo e(asset('uploads/' . $value)); ?>" alt="">
        </div>

        <?php elseif($type == 'file' && $value && $name == 'video'): ?>

        <div>
            <video class="img-thumbnail mt-1" width="500" src="<?php echo e(asset('uploads/' . $value)); ?>" alt="" controls></video>
        </div>
