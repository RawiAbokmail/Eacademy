<?php $__env->startSection('title', 'Shop Single'); ?>
<?php $__env->startSection( 'content'); ?>
    ...
    <section id="page-banner" class="pt-105 pb-130 bg_cover" data-overlay="8" style="background-image: url(<?php echo e(asset('backend/images/page-banner-5.jpg')); ?>)">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="pills-image-1" role="tabpanel" aria-labelledby="pills-image-1-tab">
                                    <div class="shop-image">
                                        <a href="images/shop-singel/ss-1.jpg" class="shop-items"><img src="<?php echo e(asset('products/'. $product->image)); ?>" alt="Shop"></a>
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="pills-image-2" role="tabpanel" aria-labelledby="pills-image-2-tab">
                                    <div class="shop-image">
                                        <a href="images/shop-singel/ss-2.jpg" class="shop-items"><img src="<?php echo e(asset('backend/images/shop-singel/ss-2.jpg')); ?>" alt="Shop"></a>
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="pills-image-3" role="tabpanel" aria-labelledby="pills-image-3-tab">
                                    <div class="shop-image">
                                        <a href="images/shop-singel/ss-3.jpg" class="shop-items"><img src="<?php echo e(asset('backend/images/shop-singel/ss-3.jpg')); ?>" alt="Shop"></a>
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="pills-image-4" role="tabpanel" aria-labelledby="pills-image-4-tab">
                                    <div class="shop-image">
                                        <a href="images/shop-singel/ss-1.jpg" class="shop-items"><img src="<?php echo e(asset('backend/images/shop-singel/ss-1.jpg')); ?>" alt="Shop"></a>
                                    </div>
                                </div>
                            </div>
...
<div class="add-btn pt-15">
    <a id="addToCartBtn" href="<?php echo e(route('eacademy.cart.add', $product)); ?>">
                ...
                <div class="row justify-content-center">
                    <?php $__currentLoopData = $relatedProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $related): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="singel-publication mt-30">
                            <div class="image">
                                <img src="<?php echo e(asset('products/' . $related->image)); ?>" alt="Publication">
                                <div class="add-cart">
                                    <ul>
                            ...
                            <div class="cont">
                                <div class="name">
                                    <a href="shop-singel.php"><h6><?php echo e($related->title); ?></h6></a>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\Eacademy\resources\views/eacademy/shop-single.blade.php ENDPATH**/ ?>