...
<?php $__env->startSection( 'content'); ?>
   ...
   <!--====== SLIDER PART START ======-->
    ...
    <section id="slider-part" class="slider-active">
        <div class="single-slider slider-2 bg_cover" style="background-image: url(<?php echo e(asset('backend/images/slider/s-2.jpg')); ?>)" data-overlay="4">
            <div class="container">
                <div class="row">
        ...
        <div class="single-slider slider-2 bg_cover" style="background-image: url(<?php echo e(asset('backend/images/slider/s-3.jpg')); ?>)" data-overlay="4">
            <div class="container">
                <div class="row">
                    <div class="col-xl-9 col-lg-10">
                        <div class="slider-cont">
        ...
        <div class="single-slider slider-2 bg_cover" style="background-image: url(<?php echo e(asset('backend/images/slider/s-1.jpg')); ?>)" data-overlay="4">
            <div class="container">
                <div class="row">
                    <div class="col-xl-9 col-lg-10">
                        <div class="slider-cont">
...
<?php endif; ?>
                    ...
                    <div class="happy-student mt-55">
                        ...
                        <div class="student-slied">
                            <div class="singel-student">
                                <img src="<?php echo e(asset('backend/images/teachers/teacher-2/quote.png')); ?>" alt="Quote">
                        ...
                        <div class="student-image">
                            <img src="<?php echo e(asset('backend/images/teachers/teacher-2/happy.png')); ?>" alt="Image">
                        </div>
                    </div> <!-- happy student -->
                </div>
            </div> <!-- row -->
    ...
    <section id="event-part" class="pt-120">
        <div class="container">
            <div class="event-bg bg_cover" style="background-image: url(<?php echo e(asset('backend/images/bg-3.jpg')); ?>)">
                <div class="row">
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\Eacademy\resources\views/eacademy/index.blade.php ENDPATH**/ ?>