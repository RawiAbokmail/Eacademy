            ...
            <div class="col-md-8">
                <div class="card shadow-lg border-0 rounded-lg">
                    <div class="card-header bg-dark text-white">
                        <h3 class="mb-0">New Teacher Details</h3>
                    </div>
                    <div class="card-body bg-light">
                        <form action="{{ route('dashboard.teachers.store') }}" method="POST" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            <div class="form-row">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    <x-form.input type="text" name="description" label="Description" class="form-control rounded-pill" placeholder="type your message" />
                                </div>
                            ...
                            <div class="form-group text-right mt-4">
                                <button type="submit" class="btn btn-dark btn-lg rounded-pill px-5 shadow">Add Teacher</button>
                            </div>
                        </form>
                    </div>
                </div>
