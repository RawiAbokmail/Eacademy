...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link" >
      <img src="{{ asset('backend/images/logo-2.png') }}" alt="AdminLTE Logo" class="brand-image elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link {{ (request()->routeIs('dashboard.users.index') || request()->routeIs('dashboard.users.create')) ? 'active' : '' }}">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{ route('dashboard.blogs.create') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Blog</p>
                </a>
              </li>
           ...
           <li class="nav-item">
            <a href="#" class="nav-link {{ (request()->routeIs('dashboard.tags.index') || request()->routeIs('dashboard.tags.create')) ? 'active' : '' }}">
           ...
           <li class="nav-item">
            <a href="#" class="nav-link {{ (request()->routeIs('dashboard.categories.index') || request()->routeIs('dashboard.categories.create')) ? 'active' : '' }}">
           ...
           <li class="nav-item">
            <a href="#" class="nav-link {{ (request()->routeIs('dashboard.courses.index') || request()->routeIs('dashboard.courses.create')) ? 'active' : '' }}">
              <p>
                Courses
                <i class="right fas fa-angle-left"></i>
              </p>
           ...
           <li class="nav-item">
            <a href="#" class="nav-link {{ (request()->routeIs('dashboard.lectures.index') || request()->routeIs('dashboard.lectures.create')) ? 'active' : '' }}">
              <p>
                Lectures
                <i class="right fas fa-angle-left"></i>
              </p>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('dashboard.lectures.index') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>All lectures</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('dashboard.lectures.create') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add lecture</p>
                </a>
              </li>
           ...
           <li class="nav-item">
            <a href="#" class="nav-link {{ (request()->routeIs('dashboard.events.index') || request()->routeIs('dashboard.events.create')) ? 'active' : '' }}">
              <p>
                Events
                <i class="right fas fa-angle-left"></i>
              </p>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('dashboard.events.index') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>All Events</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('dashboard.events.create') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Event</p>
                </a>
              </li>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2025-2030 <a href="{{ route('eacademy.index') }}">Eacademy</a>.</strong>
    All rights reserved.
