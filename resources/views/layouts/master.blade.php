...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('backend/css/new.css') }}">
@yield('css')
</head>
<style>
    th{
                ...
                <div class="row align-items-center">
                    <div class="col-lg-8">
                        <div class="header-contact text-lg-left text-center">
                            <ul>
                                <li><img src="{{ asset('backend/images/all-icon/call.png') }}" alt="icon"><span>(124) 123 675 598</span></li>
                                <li><img src="{{ asset('backend/images/all-icon/email.png') }}" alt="icon"><span>info@yourmail.com</span></li>
                                <li><img src="{{ asset('backend/images/all-icon/map.png') }}" alt="icon"><span>127/5 Mark street, New york</span></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-4">
                ...
                <div class="row no-gutters">
                    <div class="col-lg-11 col-md-10 col-sm-9 col-9">
                        <nav class="navbar navbar-expand-lg">
                            <a class="navbar-brand" href="{{ route('eacademy.index') }}">
                                <img src="{{ asset('backend/images/log.png') }}" width="160" alt="Logo">
                            </a>
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                <ul class="navbar-nav ml-auto">
                                    <li class="nav-item">
                                        <a class="{{ request()->routeIs('eacademy.index')? 'active' : '' }}" href="{{ route('eacademy.index') }}">Home</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="{{ request()->routeIs('eacademy.about')? 'active' : '' }}" href="{{ route('eacademy.about') }}">About us</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="{{ request()->routeIs('eacademy.courses')? 'active' : '' }}" href="{{ route('eacademy.courses') }}">Courses</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="{{ request()->routeIs('eacademy.events')? 'active' : '' }}" href="{{ route('eacademy.events') }}">Events</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="{{ request()->routeIs('eacademy.teachers')? 'active' : '' }}" href="{{ route('eacademy.teachers') }}">Our teachers</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="{{ request()->routeIs('blogs.index')? 'active' : '' }}" href="{{ route('eacademy.blogs') }}">Blog</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="{{ request()->routeIs('eacademy.shop')? 'active' : '' }}" href="{{ route('eacademy.shop') }}">Shop</a>
                                    </li>
                                    <li class="nav-item">
                    ...
                    <div class="col-lg-1 col-md-2 col-sm-3 col-3">
                        <div class="right-icon text-right">
                            <ul>
                                ...
                                <li><a href="{{ route('eacademy.cart') }}"><i class="fa fa-shopping-bag "></i><span>0</span></a></li>
                            </ul>
                        </div> <!-- right icon -->
                    </div>
                </div> <!-- row -->
...
@yield('content')
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-about mt-40">
                            <div class="logo">
                                <a href="#"><img src="{{ asset('backend/images/la.png') }}"
    ...
    <!--====== Ajax Contact js ======-->
    <script src="{{ asset('backend/js/ajax-contact.js') }}"></script>
    ...
    <script src="{{ asset('backend/js/map-script.js') }}"></script>
    @yield('js')
