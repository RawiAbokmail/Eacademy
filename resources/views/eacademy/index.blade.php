...
@section( 'content')
   ...
   <!--====== SLIDER PART START ======-->
    ...
    <section id="slider-part" class="slider-active">
        <div class="single-slider slider-2 bg_cover" style="background-image: url({{ asset('backend/images/slider/s-2.jpg') }})" data-overlay="4">
            <div class="container">
                <div class="row">
        ...
        <div class="single-slider slider-2 bg_cover" style="background-image: url({{ asset('backend/images/slider/s-3.jpg') }})" data-overlay="4">
            <div class="container">
                <div class="row">
                    <div class="col-xl-9 col-lg-10">
                        <div class="slider-cont">
        ...
        <div class="single-slider slider-2 bg_cover" style="background-image: url({{ asset('backend/images/slider/s-1.jpg') }})" data-overlay="4">
            <div class="container">
                <div class="row">
                    <div class="col-xl-9 col-lg-10">
                        <div class="slider-cont">
            ...
            <div class="row course-slied mt-30">
                ...
                <div class="col-lg-4">
                    <div class="singel-course-2">
                        <div class="thum">
                            ...
                            <div class="course-teacher">
                                <div class="thum">
                                    <a href="courses-singel.html"><img src="{{ asset('backend/images/course/teacher/t-2.jpg') }}" alt="teacher"></a>
                                </div>
                                <div class="name">
                                    <a href="teachers-singel.php"><h6>Mark anthem</h6></a>
                                </div>
                ...
                <div class="col-lg-4">
                    <div class="singel-course-2">
                        <div class="thum">
                            <div class="image">
                                <img src="{{ asset('backend/images/course/cu-3.jpg') }}" alt="Course">
                            </div>
                            <div class="price">
                                <span>Free</span>
                            </div>
                            <div class="course-teacher">
                                <div class="thum">
                                    <a href="courses-singel.html"><img src="{{ asset('backend/images/course/teacher/t-3.jpg') }}" alt="teacher"></a>
                                </div>
                                <div class="name">
                                    <a href="teachers-singel.php"><h6>Mark anthem</h6></a>
                                </div>
                ...
                <div class="col-lg-4">
                    <div class="singel-course-2">
                        <div class="thum">
                            <div class="image">
                                <img src="{{ asset('backend/images/course/cu-4.jpg') }}" alt="Course">
                            </div>
                            <div class="price">
                                <span>Free</span>
                            </div>
                            <div class="course-teacher">
                                <div class="thum">
                                    <a href="courses-singel.html"><img src="{{ asset('backend/images/course/teacher/t-4.jpg') }}" alt="teacher"></a>
                                </div>
                                <div class="name">
                                    <a href="teachers-singel.php"><h6>Mark anthem</h6></a>
                                </div>
                ...
                <div class="col-lg-4">
                    <div class="singel-course-2">
                        <div class="thum">
                            <div class="image">
                                <img src="{{ asset('backend/images/course/cu-5.jpg') }}" alt="Course">
                            </div>
                            <div class="price">
                                <span>Free</span>
                            </div>
                            <div class="course-teacher">
                                <div class="thum">
                                    <a href="courses-singel.html"><img src="{{ asset('backend/images/course/teacher/t-5.jpg') }}" alt="teacher"></a>
                                </div>
                                <div class="name">
                                    <a href="teachers-singel.php"><h6>Mark anthem</h6></a>
                                </div>
                    ...
                    <div class="happy-student mt-55">
                        ...
                        <div class="student-slied">
                            <div class="singel-student">
                                <img src="{{ asset('backend/images/teachers/teacher-2/quote.png') }}" alt="Quote">
                        ...
                        <div class="student-image">
                            <img src="{{ asset('backend/images/teachers/teacher-2/happy.png') }}" alt="Image">
                        </div>
                    </div> <!-- happy student -->
                </div>
            </div> <!-- row -->
    ...
    <section id="event-part" class="pt-120">
        <div class="container">
            <div class="event-bg bg_cover" style="background-image: url({{ asset('backend/images/bg-3.jpg') }})">
                <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="singel-news news-list">
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="news-thum mt-30">
                                    <img src="{{ asset('backend/images/news/ns-2.jpg') }}" alt="News">
                                </div>
                            </div>
                            <div class="col-sm-8">
                                <div class="news-cont mt-30">
                    ...
                    <div class="singel-news news-list">
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="news-thum mt-30">
                                    <img src="{{ asset('backend/images/news/ns-3.jpg') }}" alt="News">
                                </div>
                            </div>
                            <div class="col-sm-8">
                                <div class="news-cont mt-30">
